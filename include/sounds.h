...
/* ---------------------- SOUND EFFECTS ---------------------- */
#define SE_LIFE_METER_DANGER    0x4800
#define SE_LIFE_REPLENISH       0x4801
#define SE_MAP_OPEN             0x4802
...
#define SE_WATER_METER_LOSE     0x480C

#define SE_MENU_CURSOR_MOVE     0x480F
#define SE_OPEN_SAVE_FILE       0x4810
#define SE_GET_COIN             0x4811
#define SE_DEBBS_ALERT_APPEAR   0x4812
#define SE_COIN_APPEAR          0x4813
#define SE_SHINE_TOUCH          0x4814

#define SE_NOTICE_OPEN          0x4819
#define SE_NOTICE_CLOSE         0x481A

#define SE_SHINE_APPEAR         0x4821
#define SE_FIRST_PERSON_LOOK    0x4824
#define SE_FIRST_PERSON_STOP    0x4825
#define SE_CAMERA_ADJUST        0x4826
#define SE_TEXT_APPEAR          0x4827

#define SE_TIME_SLOW            0x4835
#define SE_TIME_FAST            0x4836
#define SE_TIME_FASTER          0x4837
#define SE_TIME_FASTEST         0x4838
#define SE_TIME_FASTESTEST      0x4839
#define SE_TIME_FASTESTESTEST   0x483A

#define SE_DENY                 0x483D
#define SE_YOSHI_DENY_FRUIT     0x483E
#define SE_ACCEPT               0x483F
#define SE_YOSHI_ACCEPT_FRUIT   0x4840
#define SE_LIFE_UP              0x4841
#define SE_COIN_DROP            0x4842
#define SE_BLUE_COIN_APPEAR     0x4843
#define SE_NPC_CLEAN            0x4844
#define SE_BLUE_COIN_GET        0x4845
#define SE_ONE_UP_GET           0x4846
#define SE_POLLUTION_CLEAN      0x4847

#define SE_YOSHI_FIRST_RIDE     0x4849

/* ---------------------- STAGE BGMS ---------------------- */
#define BGM_DOLPIC          0x80010001 // delfino plaza
#define BGM_BIANCO          0x80010002 // bianco hills
#define BGM_MAMMA           0x80010003 // gelato beach
...
#define BGM_BOSS            0x8001000D // boss battle
...
#define BGM_KAGEMARIO       0x80010016 // shadow mario
